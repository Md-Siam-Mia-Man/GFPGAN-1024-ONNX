...
if __name__ == "__main__":
    ...
    faceaugment = GFPGANFaceAugment(model=args.model)
    image = cv2.imread(args.input, 1)
    output, _ = faceaugment.forward(image)
    cv2.imwrite(args.output, output)

# python demo_onnx.py --model GFPGANv1.4.onnx --input ./input/Adele_crop.png


# python demo_onnx.py --model GFPGANv1.2.onnx --input ./input/Adele_crop.png --output Adele_v2.jpg
# python demo_onnx.py --model GFPGANv1.2.onnx --input ./input/Julia_Roberts_crop.png --output Julia_Roberts_v2.jpg
# python demo_onnx.py --model GFPGANv1.2.onnx --input ./input/Justin_Timberlake_crop.png --output Justin_Timberlake_v2.jpg
# python demo_onnx.py --model GFPGANv1.2.onnx --input ./input/Paris_Hilton_crop.png --output Paris_Hilton_v2.jpg
